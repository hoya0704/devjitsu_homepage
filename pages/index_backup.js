...
const menus = [
  ...
  { href: '#skills', label: 'skills', class: 'wrapper style3 fade-up' },
  { href: '#process', label: 'process', class: 'wrapper style2 fade-up' },
                ...
                <div className="split style1">
                  <section>
                    <form method="post" action="#">
                      ...
                      <ul className="actions">
                        <li><a href="true" className="button submit">Send Message</a></li>
                      </ul>
                    </form>
                  </section>
                  <section>
